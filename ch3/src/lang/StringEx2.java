...
public class StringEx2 {
    public static void main(String[] args) {
        ...
        str1 = "aaa";
        str2 = "bbb";
        System.out.println("str1.compareTo(aaa) = " + str1.compareTo("bbb")); // 0
        ...
        System.out.println("str1.indexOf('e') " + str1.indexOf("el"));
        ...
        // 11) startsWith() : 주어진 문자열 prefix로 시작하는지 검사 <==> endsWith()
        str1 = "java.lang.Object";
